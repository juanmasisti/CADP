...
Procedure cargarVector(Var ing: ingresante; Var dmL: integer);
...
Begin
  ...
  writeln('DNI: ');
  readln(alumnos.DNI);
  While (alumnos.DNI<>-1) And (dmL<=tam) Do
    Begin
...
Begin
  ...
  For i:= 1 To dmL Do
    ...
    End;
  writeln(cantDniPar);
  writeln('El porcentaje de alumnos con DNI de digitos pares es: ', cantDniPar*100/dmL:2:2, '%');
