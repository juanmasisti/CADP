...
Procedure max(cod: integer; km: real; Var codMax1, codMax2: integer; Var kmMax1,
              kmMax2: real);
Begin
  If (km>kmMax1) Then
    Begin
...
Procedure analizarLista(L: lista; Var L2: lista; Var codMax1, codMax2:
                        integer);
...
Begin
  ...
  writeln('Los codigos de los autos con mayor km Recorridos son ', codMax1,
          ' y ', codMax2);
End.
